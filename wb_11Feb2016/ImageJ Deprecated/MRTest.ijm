macro "MRTets Action Tool - B1dCc00T0012WTa012B "  { 
...
run("Image Sequence...", "open=["+dir+"] starting=1 increment=1 scale=100 sort");	
run("MultiStackRegSaul ", "action_1=Align file_1=[] stack_2=None action_2=Ignore file_2=[] transformation=Translation save");
// run("MultiStackReg", "stack_1=TMIPS-Z"+paddedZ[z]+" action_1=Align file_1=[] stack_2=None action_2=Ignore file_2=[] transformation=Translation save");
...
for (z=0;z<numZ;z++) {
	...
	close();	
	selectWindow("TMIPS-Z"+paddedZ[z]+".log");
	saveAs("text", dir+"SmoothStabZMovies/SmoothStabMovie_Z"+paddedZ[z]+".log");
	run("Close");
