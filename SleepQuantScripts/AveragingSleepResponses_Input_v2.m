...
% use excel with input names? 1=yes, 0=non use current working directory:
useExcelInput = 1;

%%% Below: put in information about where to get file names if you are
%%% inputting them.
%Get data names:
