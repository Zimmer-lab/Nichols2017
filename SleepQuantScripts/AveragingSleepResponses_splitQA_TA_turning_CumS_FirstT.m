...
saveDir = 'V:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_5.Figures\revisions\_Dish_24m_6m_20170404'; %'/Volumes/Annika_Nichols/_Let_Assays/_5_ALS_ToAverage/_5.Figures/revisions';%'\\storage.imp.ac.at\groups\zimmer\Annika_Nichols\_5_ALS_ToAverage\_3.RESULTS\_20160531';
...
movieFrames = ceil(lengthOfRecording*60*SampleRate);
...
for i = 1: size(walkDir,1)
    ...
    if walkDir(i).isdir == 1 && strcmp(walkDir(i).name, '.') == 0 ...
        ...
        PlotAvgSelect_splitQA_Turn_CumS_FirstT(OutputFileName, currFolder, 'sleep', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned,InstMotionState);
        PlotAvgSelect_splitQA_Turn_CumS_FirstT(OutputFileName, currFolder, 'wake', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned,InstMotionState);
