...
function PlotAvgSelect_MassiveP_speed_130516_greenPreL(FilePrefix, PlotTitle, StateToPlot, BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec)
    ...
    if  strcmp(StateToPlot,'sleep')
        ...
        plot(StResh,mnFollowingStateSleep,'g','linewidth',2.5);
        ...
        plot(StResh,mnOfractSleep,'g','linewidth',2.5);
        ...
        plot(StResh,mnLRfractSleep,'g','linewidth',2.5);
        ...
        if size(timeplot,2) > 0
            ...
            hold on;
            plot(timeplot,BinOSleepPlot,'g','linewidth',2.5);
        ...
        if size(timeplot,2) > 0
            ...
            hold on;
            plot(timeplot,BinLRSleepPlot,'g','linewidth',2.5);
