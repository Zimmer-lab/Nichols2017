...
%based off: PlotAvgSelect_MassiveP_speed_plotIndivCurves_20160628_AN_Input
function PlotAverageMotionState_v2(FilePrefix, PlotTitle, StateToPlot, BinWinSec, DatasetPointer, ...
                                                SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, ...
                                                BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,SelectData,DataRange,FirstStimulus)
...
%     FirstStimulus = [1560 360]; %start and width of first stimulus
    ...
    Oymax=0.05; %AN is 0.05, normal is 0.04
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %removed SelectData as it is calculated in the
    %AveragingSleepResponses_Input script.
    ...
    if  strcmp(StateToPlot,'sleep')
        ...
        for currCurve = 1:size(DatasetPointer,1)
            currCurveName = 'npr-1_control'; %currFiles(currCurve).name;
