...
saveDir = 'Y:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_5.Figures\revisions';%'\\storage.imp.ac.at\groups\zimmer\Annika_Nichols\_5_ALS_ToAverage\_3.RESULTS\_20160531';
...
for i = 1 : size(walkDir,1)
    ...
    if walkDir(i).isdir == 1 && strcmp(walkDir(i).name, '.') == 0 ...
        ...
        stimuli = [1560,360]; %stim 1 start, stim 1 width, stim 2 start, stim 2 width ....
        spdxmax = 5400;
        ...
        PlotAvgSelect_MassiveP_speed_plotIndivCurves_20160628_AN(OutputFileName, currFolder, 'sleep', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec);
        PlotAvgSelect_MassiveP_speed_plotIndivCurves_20160628_AN(OutputFileName, currFolder, 'wake', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec);
