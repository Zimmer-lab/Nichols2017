...
saveDir ='V:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_5.Figures\revisions\Last_chance_stats';
...
for dirIdx = 1 : size(walkDir,1)
    ...
    if walkDir(dirIdx).isdir == 1 && strcmp(walkDir(dirIdx).name, '.') == 0 && strcmp(walkDir(dirIdx).name, '..') == 0
        ...
        if size(Files,1) > 0
            ...
            CollectedTrksInfo.SleepAllSpdBinned = [];
            CollectedTrksInfo.WakeAllSpdBinned = [];
            FileNameCell = {};
            ...
            for CurrAlsFile = 1:NumberOfAlsFiles
                ...
                [Oresponse1Wake(CurrAlsFile),Oresponse1Sleep(CurrAlsFile),LRresponse1Wake(CurrAlsFile),...
                    ...
                    FractionTurn1Sleep,FractionTurn1Wake,Spd1Sleep,Spd1Wake] = ... %AN 2016/06/22, added FractionMotion1Sleep/Wake, 2016/8/8 added SpeedResponse1Wake,SpeedResponse1Sleep, Removed SpeedResponse1Wake(CurrAlsFile),SpeedResponse1Sleep(CurrAlsFile) and replaced with SpeedBasalRate1Wake(CurrAlsFile), SpeedResponseRate1Wake(CurrAlsFile),SpeedResponseRate1Sleep(CurrAlsFile)
                    ROSpdQuantV3_ANSpdFT2(SBinTrcksSpdSize,BinTrcksO,BinTrcksLR,BinTrcksSR,wakestate,motionstate,AllTurnStartsBinned,t,NumBins,NumTracks,BinWinSec,...
                ...
                [Oresponse2Wake(CurrAlsFile),Oresponse2Sleep(CurrAlsFile),LRresponse2Wake(CurrAlsFile),...
                    ...
                    FractionTurn2Sleep,FractionTurn2Wake,Spd2Sleep,Spd2Wake] = ... %AN 2016/06/22, added FractionMotion2Sleep/Wake, 2016/8/8 added SpeedResponse1Wake,SpeedResponse1Sleep
                    ROSpdQuantV3_ANSpdFT2(SBinTrcksSpdSize,BinTrcksO,BinTrcksLR,BinTrcksSR,wakestate,motionstate,AllTurnStartsBinned,t,NumBins,NumTracks,BinWinSec,...
                ...
                for stim = beginP:endP; %to cover both stimuli
                    ...
                    stimNumberSpd = {Spd1Sleep,Spd1Wake,Spd2Sleep,Spd2Wake};
                    ...
                    CollectedTrksInfo.SleepAllSpdBinned = [CollectedTrksInfo.SleepAllSpdBinned; stimNumberSpd{stim1}(trackidxSleep,:)];
                    CollectedTrksInfo.WakeAllSpdBinned = [CollectedTrksInfo.WakeAllSpdBinned; stimNumberSpd{stim1+1}(trackidxWake,:)];
