...
controlDir = 'V:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_2.Lethargus+PostLet\_new\_controlDatasets';
%controlDir = 'V:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_1.PreLet\_new\_NPR1controls';
saveDir = 'V:\Annika_Nichols\_Let_Assays\_5_ALS_ToAverage\_5.Figures\pdfs';

%Get data names:
excelInputFolder = 'V:\Annika_Nichols';

cd(excelInputFolder);

%Specify excel sheet data cells.
dataNameInput = xlsread('Data_and_NPR1_ID_Controls.xlsx','pdfs','I39:I56');

%used for naming
controlfor = 'figureS4_pdf_speed_18C_O2_21_s_2.Let_';
