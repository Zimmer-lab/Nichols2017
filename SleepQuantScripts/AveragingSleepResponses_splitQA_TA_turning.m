...
for i = 1 : size(walkDir,1)
    ...
    if walkDir(i).isdir == 1 && strcmp(walkDir(i).name, '.') == 0 ...
        ...
        PlotAvgSelect_splitQA_Turn(OutputFileName, currFolder, 'sleep', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned);
        PlotAvgSelect_splitQA_Turn(OutputFileName, currFolder, 'wake', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned);
