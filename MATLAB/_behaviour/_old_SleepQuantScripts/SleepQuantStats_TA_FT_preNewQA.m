...
saveDir ='/Volumes/zimmer/Annika/_Reversal_Omega_Checking';
...
ConditionalBinQASec1 = [1540 1560];
...
for dirIdx = 1 : size(walkDir,1)
    ...
    if walkDir(dirIdx).isdir == 1 && strcmp(walkDir(dirIdx).name, '.') == 0 && strcmp(walkDir(dirIdx).name, '..') == 0
        ...
        if size(Files,1) > 0
            ...
            CollectedTrksInfo.AllTurnStarts = [];
            CollectedTrksInfo.AllTurnStartsBinned = [];
            countingAls =1;
            ...
            for CurrAlsFile = 1:NumberOfAlsFiles
                ...
                for stim = beginP:endP; %to cover both stimuli
                    ...
                    if stim == 1;
                        ...
                        ConditionalBinQASec = floor(ConditionalBinQASec1 / SBinWinSec);
                    else
                        ConditionalBinFr = floor(ConditionalBinSec2 / SBinWinSec);
                        ConditionalBinQASec = floor(ConditionalBinQASec2 / SBinWinSec);
                    end
                    ...
                    for i=1:r;
                        ...
                        if sum(wakestate(i,ConditionalBinFr(1):ConditionalBinFr(2)))==0;
                            ...
                            if sum(motionstate(i,ConditionalBinQASec(1):ConditionalBinQASec(2)))==0
                                SleepTracksQuiescent(i,1) = countSleepTracks;
                                
                            elseif sum(motionstate(i,ConditionalBinQASec(1):ConditionalBinQASec(2)))==(1+ConditionalBinQASec(2)-ConditionalBinQASec(1));
                    ...
                    CollectedTrksInfo.AllTurnStartsBinned = [CollectedTrksInfo.AllTurnStartsBinned; stimNumberFractionTurns{stim1}(trackidxSleep,:)];
