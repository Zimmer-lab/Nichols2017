...
%motinstate. This is a bug based on a 540frame cutoff before adding activity bouts to a track.
%Make sure you use then minTrackSize, or have tracks above a certain size (700 is perfect).

%NOTE! there was a small bug where active bouts were made to be 1 bin
%longer than they actually were. This also relates to the above bug that
%tracks need to be about 540 frames.
