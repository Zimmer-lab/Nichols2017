...
for i = 5 : size(walkDir,1) %%%%%!!!!!!!! it should be 1!!!!
    ...
    if walkDir(i).isdir == 1 && strcmp(walkDir(i).name, '.') == 0 ...
        ...
        PlotAvgSelect_splitQA_Turn_CumS_FirstT(OutputFileName, currFolder, 'sleep', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned);
        %PlotAvgSelect_splitQA_Turn_CumS(OutputFileName, currFolder, 'wake', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus,AllTurnStartsBinned);
