...
%21% = TimePeriod = 1:100;
%21% = TimePeriod = 150:250;

%Pharynx tracks
toPlotpixel = AllSlideSpeed(:,TimePeriod); %AllPreCOrmdwlstate(:,1:100);
%toPlotEc = aAllEccen(:,TimePeriod); %AllPreCOrmdwlstate(:,1:100);
...
%HistXedges=logspace(-3,-0.2,100); %(-0.6990,1.9031,100) %(-4,-0.6,100), -3.2,-0.2,100
HistXedges=logspace(-4,-0.2,100); %pixel size 0.00317
...
line('XData', [cutoff*pixelsize, cutoff*pixelsize], 'YData', [0, 0.04],'color','k','LineStyle', '-');
set(gca,'XScale','log')
