function background = CreateBackgroundImageShort(basename,frameinterval)

%This version is essentially the same as CreateBackgroundImage but only
%creates the background image for the first 10m of videos with 3fps (1800). Used
%for my "dish" assays. -Annika
...
for Frame = 1:frameinterval:FrameEnd
