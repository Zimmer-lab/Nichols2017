...
saveDir = pwd; %'/Volumes/Annika_Nichols/_Let_Assays/_5_ALS_ToAverage/_5.Figures/revisions';%'\\storage.imp.ac.at\groups\zimmer\Annika_Nichols\_5_ALS_ToAverage\_3.RESULTS\_20160531';
...
walkDir = dir(pwd);
for i = 5 : size(walkDir,1) %%%%%!!!!!!!! it should be 1!!!!
