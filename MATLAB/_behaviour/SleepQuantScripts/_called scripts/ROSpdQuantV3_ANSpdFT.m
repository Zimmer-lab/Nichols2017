function [Oresponse1Wake,...
    ...
    SpeedSleep,...
    SpeedWake] = ...
    ROSpdQuantV3_ANSpdFT2(SBinTrcksSpdSize,BinTrcksO,BinTrcksLR,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%MotionState and other parameter matrices 
...
SpeedSleep = SpdSleep(:,tBehaviorstateBinIdx(1):tBehaviorstateBinIdx(2));
SpeedTurnWake = SpdWake(:,tBehaviorstateBinIdx(1):tBehaviorstateBinIdx(2));
