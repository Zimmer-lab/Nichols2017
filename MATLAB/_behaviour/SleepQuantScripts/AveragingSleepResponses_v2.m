...
saveDir = '/Volumes/Annika_Nichols/_Let_Assays/_5_ALS_ToAverage/_5.Figures/npr1_noStim';%'\\storage.imp.ac.at\groups\zimmer\Annika_Nichols\_5_ALS_ToAverage\_3.RESULTS\_20160531';
...
% 20170126 made so the range range plotted is accessible 
...
for i = 1 : size(walkDir,1)
    ...
    if walkDir(i).isdir == 1 && strcmp(walkDir(i).name, '.') == 0 ...
        ...
        PlotAvgSelect_MassiveP_speed_plotIndivCurves_20170125_AN(OutputFileName, currFolder, 'sleep', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus);
        PlotAvgSelect_MassiveP_speed_plotIndivCurves_20170125_AN(OutputFileName, currFolder, 'wake', BinWinSec, DatasetPointer, SBinTrcksSpdSize, BinTrcksO, BinTrcksLR, BinTrcksSR, wakestate, motionstate, BinTrcksOstate, BinTrcksLRstate, BinTrcksSRstate, SBinWinSec,DataRange,FirstStimulus);
