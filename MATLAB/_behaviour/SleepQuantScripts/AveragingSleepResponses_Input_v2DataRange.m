...
saveDir = '/Volumes/Annika_Nichols/_Let_Assays/_5_ALS_ToAverage/_5.Figures/npr1_noStim';
...
%used for naming
controlfor = 'Homeostatic_effects_18C_O2_21_s_2.Let_';
...
if size(IncludedRecording,1) > 0
    ...
    PlotAverageMotionState_v2(SaveQuantDataFilename,...
        ...
        SBinWinSec,SelectData,DataRange,FirstStimulus);
