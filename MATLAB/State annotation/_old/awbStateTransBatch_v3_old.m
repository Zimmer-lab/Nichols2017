...
ResultsStructFilename = 'StateTrans_AVArisetriggered_360sTo370s_15sThres_QFoff';
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
options.version.awbStateTransBatch = 'v3_20160323'; 
...
NeuronNum = length(Neurons);
    ...
    heatmap(toPlot, 1:100, NeuronsPlot, [], 'NaNColor', [0 0 0], 'ShowAllTicks', true, 'MinColorValue', -15, 'MaxColorValue', 15); %'TickAngle', 45,'TickFontSize', 6
    %caxis([-15 15]);
...
clearvars i idx idx3 idx4 iii bbb        