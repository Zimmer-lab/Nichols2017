...
for recNum = 1:NumDataSets
    ...
    %Included transitions that go directly from a Reversal into
    %Quiescence
...
if resampleOn
    [eventsAboveTrueDis,rasampledDistance,trueDistance,pValue] = permuteTSTransFrequencyV1(NumEventsEndingPerBin,FRtrans,FQtrans,resampleN);
end
...
if saveFlag
    ...
    print(gcf,'ForwardTransProb10pc_log3bin_Turn.ai','-r300','-depsc')
end
