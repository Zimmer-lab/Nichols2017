...
ResultsStructFilename = 'ActiveNeurons_60sBins_0-007Deriv_slide_20161020'; %This structure will be saved in the top folder.

%Bin size in seconds
options.BinSize = 60; %make 1080 evenly divisable by this value, i.e. 20, 30, 60

%Thresholds:
options.DerivThreshold = 0.007; %0.005 or 0.007

options.FThreshold = 0.5; %0.5

%%
options.version.awbBatchActiveNeuronsSlide = 'v1_20160418';
MainDir = pwd;
...
for ii = 1:NumDataSets %Folder loop
    ...
    awbActiveNeuronsSlide; %runs for individual datasets.
    awbActiveNeuronsQASlide; 
...
%Fraction neurons inactive
QuiFractionInactive = abs(ActiveNeurons.QuiFraction-1);
ActFractionInactive = abs(ActiveNeurons.ActFraction-1);
